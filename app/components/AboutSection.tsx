...
const AboutSection = () => {
  return (
    ...
    <section className="relative w-full min-h-screen flex items-center justify-center bg-[#111111] py-20 md:py-32 px-6 md:px-12 overflow-hidden border-t border-green-500/10 z-0">
