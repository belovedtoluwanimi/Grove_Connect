...
const Toast = ({ message, type, onClose }: { message: string, type: 'success' | 'error', onClose: () => void }) => (
    <motion.div
        ...
        className={`fixed bottom-8 right-8 z-[100] flex items-center gap-4 pl-4 pr-6 py-4 rounded-xl shadow-2xl backdrop-blur-xl border border-white/10 ${type === 'success' ? 'bg-green-900/90 text-white' : 'bg-red-900/90 text-white'
            }`}
    >
