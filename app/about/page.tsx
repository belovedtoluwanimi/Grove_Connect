      ...
      <div ref={heroWrapperRef} className="h-[150vh] relative z-10 w-full">
        ...
        >
          <div className="max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-black text-white mb-8 leading-[1.05] tracking-tight drop-shadow-2xl">
              It Started With <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-emerald-400 to-cyan-500">
                A Microphone.
              </span>
            </h1>
            <p className="text-2xl md:text-3xl text-zinc-400 leading-relaxed font-medium max-w-3xl mx-auto">
